    ...
    const arrInstancesTasks = arrTask.map(function(e){
        let {name, completed, createdAt, updatedAt} = e // Extrai todos as propriedades do obj passado, a variável deve ter o mesmo nome, como não foi diferenciada a propriedade e valor, entendesse que a propriedada é name e o valor é name por exemplo
        return new Task(name, completed, createdAt, updatedAt) // Usando os valores extraidos para integrar a função construtora e construir os novos obj dentro do arrInstancesTasks
